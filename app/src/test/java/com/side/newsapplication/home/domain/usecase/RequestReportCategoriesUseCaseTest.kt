...
class RequestReportCategoriesUseCaseTest{
    ...
    private lateinit var requestReportCategoriesUseCase: RequestReportCategoriesUseCase
    ...
    fun setUp() {
        ...
        requestReportCategoriesUseCase = RequestReportCategoriesUseCase(apiServices)
    }
    @AfterEach
    fun tearDown() {
    ...
    fun `validate network error`() = runTest {
        ...
        apiServices =
            Retrofit.Builder()
                ...
                .build().create(ApiServices::class.java)
        requestReportCategoriesUseCase = RequestReportCategoriesUseCase(apiServices)
        val response = requestReportCategoriesUseCase("")
        println("network error test response = $response")
        Truth.assertThat(
            (response is RequestReportCategoriesUseCase.RequestReportCategoriesUseCaseResult.StateSError)
    ...
    fun `validate error response`() = runTest {
        ...
        val response = requestReportCategoriesUseCase("")
        println("network error test response = $response")
        Truth.assertThat(response is RequestReportCategoriesUseCase.RequestReportCategoriesUseCaseResult.StateSError).isTrue()
    }
    @Test
    fun `validate session timeout error response`() = runTest {
        ...
        val response = requestReportCategoriesUseCase("")
        println("network error test response = $response")
        Truth.assertThat(response is RequestReportCategoriesUseCase.RequestReportCategoriesUseCaseResult.StateSessionTimeout).isTrue()
    }
    ...
    fun `validate success response`() = runTest {
        ...
        webServer.enqueue(mockResponse)
        val response = requestReportCategoriesUseCase.invoke("test")
        println("network error test response = $response")
        Truth.assertThat(response is RequestReportCategoriesUseCase.RequestReportCategoriesUseCaseResult.StateSuccess).isTrue()
    }
