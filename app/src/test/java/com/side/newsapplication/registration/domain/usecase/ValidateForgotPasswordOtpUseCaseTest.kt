...
class ValidateForgotPasswordOtpUseCaseTest {
    ...
    private lateinit var validateOtpUseCase: ValidateForgotPasswordOtpUseCase
    ...
    fun setUp() {
        ...
        validateOtpUseCase = ValidateForgotPasswordOtpUseCase(mockedContext, apiServices)
    }
    ...
    fun `validate network error`() = runTest {
        ...
        apiServices =
            Retrofit.Builder()
                ...
                .build().create(ApiServices::class.java)
        validateOtpUseCase = ValidateForgotPasswordOtpUseCase(mockedContext, apiServices)
        val response = validateOtpUseCase("")
        println("network error test response = $response")
        Truth.assertThat(
            (response is ValidateForgotPasswordOtpUseCase.ValidateForgotPasswordOtpUseCaseResult.StateSError)
    ...
    fun `validate error response`() = runTest {
        ...
        val response = validateOtpUseCase("")
        println("network error test response = $response")
        Truth.assertThat(response is ValidateForgotPasswordOtpUseCase.ValidateForgotPasswordOtpUseCaseResult.StateSError)
            .isTrue()
    }
    ...
    fun `validate session timeout error response`() = runTest {
        ...
        val response = validateOtpUseCase("")
        println("network error test response = $response")
        Truth.assertThat(response is ValidateForgotPasswordOtpUseCase.ValidateForgotPasswordOtpUseCaseResult.StateSessionTimeout)
            .isTrue()
    }
    ...
    fun `validate success response`() = runTest {
        ...
        val response = validateOtpUseCase("")
        println("network error test response = $response")
        Truth.assertThat(response is ValidateForgotPasswordOtpUseCase.ValidateForgotPasswordOtpUseCaseResult.StateSuccess)
            .isTrue()
    }
}