...
class OpenToPlayGamesUseCaseTest{
    ...
    private lateinit var openToPlayGamesUseCase: OpenToPlayGamesUseCase
    ...
    fun setUp() {
        ...
        openToPlayGamesUseCase = OpenToPlayGamesUseCase( apiServices)
    }
    @AfterEach
    fun tearDown() {
    ...
    fun `validate network error`() = runTest {
        ...
        apiServices =
            Retrofit.Builder()
                ...
                .build().create(ApiServices::class.java)
        openToPlayGamesUseCase = OpenToPlayGamesUseCase( apiServices)
        val response = openToPlayGamesUseCase(fakeselectedGamesList)
        println("network error test response = $response")
        Truth.assertThat(
            (response is OpenToPlayGamesUseCase.OpenToPlayGamesUseCaseResult.StateSError)
    ...
    fun `validate error response`() = runTest {
        ...
        val response = openToPlayGamesUseCase(fakeselectedGamesList)
        println("network error test response = $response")
        Truth.assertThat(response is OpenToPlayGamesUseCase.OpenToPlayGamesUseCaseResult.StateSError).isTrue()
    }
    @Test
    fun `validate session timeout error response`() = runTest {
        ...
        val response = openToPlayGamesUseCase(fakeselectedGamesList)
        println("network error test response = $response")
        Truth.assertThat(response is OpenToPlayGamesUseCase.OpenToPlayGamesUseCaseResult.StateSessionTimeout).isTrue()
    }
    @Test
    ...
    fun `validate success response`() = runTest {
        ...
        val response = openToPlayGamesUseCase(fakeselectedGamesList)
        println("network error test response = $response")
        Truth.assertThat(response is OpenToPlayGamesUseCase.OpenToPlayGamesUseCaseResult.StateSuccess).isTrue()
    }
}